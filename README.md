...
- Есть рейт лимит на подтверждение почты (кулдаун 2**retries_count, начинает 
  блокировать ввод после второй неудачной попытки)
- Пароль хэшируется алгоритмом argon2 с солью (используется готовое решение 
  ...
  в src/hack/core/services/access.py.
